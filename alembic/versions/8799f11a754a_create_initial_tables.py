...
Revision ID: 8799f11a754a
Revises: 
Create Date: 2026-09-19 15:51:47.728353
"""
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'paid', 'shipped', 'delivered', 'cancelled', name='orderstatus', native_enum=False), nullable=False),
